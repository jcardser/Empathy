...
namespace Empathy.Controllers
{
    public class HealthConditionsController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ConditionHistory,Medicine,Surgery,CardiacHistory,Weight,Height,Fracture,Sport,Menstrual,MethodMenstrual,Smoke,Beer,Occupation")] HealthCondition healthCondition)
        {
