...
namespace Empathy.Controllers
{
    public class HealthConditionsController : Controller
    {
        ...
        public async Task<IActionResult> Create(HealthCondition healthCondition)
        {
            if (ModelState.IsValid)
            {
                ...
                catch (DbUpdateException dbUpdateException)
                {
                    ...
                    {
                        ModelState.AddModelError(string.Empty, "Error, ya existe.");
                    }
                    else
                    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Surgery,Allergies,EmergencyContact,Weight,Height,Smoke,Beer,Fracture")] HealthCondition healthCondition)
        {
        ...
        {
          return (_context.HealthConditions?.Any(e => e.Id == id)).GetValueOrDefault();
        }
    }
}
