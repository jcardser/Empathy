...
namespace Empathy.Migrations
{
    ...
    [Migration("20240201232650_AddSedeAppointmentEntities")]
    partial class AddSedeAppointmentEntities
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Empathy.Data.Entities.SedeAppointment", b =>
                {
                    ...
                    b.HasIndex("AppointmentId", "SedeId")
                        .IsUnique()
                        .HasFilter("[SedeId] IS NOT NULL");

                    b.ToTable("SedeAppointmets");
                });
